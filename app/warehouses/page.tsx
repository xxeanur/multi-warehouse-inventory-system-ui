      ...
      <Box sx={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", mb: 4, flexDirection: { xs: "column", sm: "row" }, gap: 2 }}>
          <Box>
            ...
            <Typography variant="body2" sx={{ color: "#6B7280" }}>
              Depoların hacimsel doluluk oranlarını ve raf kırılımlarını takip edin
            </Typography>
          </Box>
          <Button
            variant="contained"
        ...
        <Grid container spacing={3}>
          {mockWarehouses.map((warehouse) => {
            const fillPercentage = (warehouse.currentVolume / warehouse.maxVolume) * 100;
                  ...
                  <CardContent sx={{ p: 3 }}>
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", mb: 2 }}>
                      <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                        <Box sx={{ bgcolor: "#F3F4F6", p: 1, borderRadius: 2, color: "#172C4A" }}>
                    ...
                    <Box sx={{ mt: 3 }}>
                      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
                        ...
                        <Typography variant="caption" sx={{ fontWeight: 700, color: isCritical ? "#DC2626" : "#111827" }}>
                      ...
                      <Typography variant="caption" sx={{ color: "#9CA3AF", display: "block", mt: 1 }}>
                        {warehouse.currentVolume.toLocaleString()} / {warehouse.maxVolume.toLocaleString()} cm³ kullanılıyor
                      </Typography>
                    </Box>
                  </CardContent>
                </Card>
